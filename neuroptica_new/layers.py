...
from neuroptica_new.component_layers import MZILayer, OpticalMesh, PhaseShifterLayer
from neuroptica_new.nonlinearities import Nonlinearity
...
class DiamondLayer(OpticalMeshNetworkLayer): 
    ...
    def __init__(self, N: int, include_phase_shifter_layer=False, initializer=None, phases=[(None, None)], loss_dB=0, loss_diff=0, phase_uncert=0.0):
        ...
        self.mzi_limits_lower = self.mzi_limits_lower[N//2-1:N//2+N-1] # for truncated diamond
        self.mzi_limits_upper = self.mzi_limits_upper[N//2-1:N//2+N-1] # for truncated diamond
